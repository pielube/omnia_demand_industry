...
INPUT_PATH = OUTPUTS_DIR / "aluminium_secondary_country_projection_2019_2050.csv"
OUTPUT_DIR = OUTPUTS_DIR / "figures"
OUTPUT_PNG = OUTPUT_DIR / "aluminium_secondary_top9_2019_3x3.png"
OUTPUT_PDF = OUTPUT_DIR / "aluminium_secondary_top9_2019_3x3.pdf"
...
def make_figure():
    ...
    plot_data = plot_data.melt(
        ...
        value_vars=years,
        var_name="Year",
        value_name="SecondaryProduction_kt",
    )
    plot_data["SecondaryProduction_Mt"] = plot_data["SecondaryProduction_kt"] / 1000
    ...
    fig.supylabel("Secondary aluminium ingot production (Mt)", fontsize=8)
    fig.suptitle(
        "Secondary aluminium projections for the nine largest 2019 producers",
        x=0.01,
        ha="left",
        fontsize=10,
        fontweight="bold",
