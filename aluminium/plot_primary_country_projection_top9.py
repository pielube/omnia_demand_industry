...
INPUT_PATH = OUTPUTS_DIR / "aluminium_primary_country_projection_2019_2050.csv"
OUTPUT_DIR = OUTPUTS_DIR / "figures"
OUTPUT_PNG = OUTPUT_DIR / "aluminium_primary_top9_2019_3x3.png"
OUTPUT_PDF = OUTPUT_DIR / "aluminium_primary_top9_2019_3x3.pdf"
...
def make_figure():
    ...
    fig.suptitle(
        "Primary aluminium projections for the nine largest 2019 producers",
        x=0.01,
        ha="left",
        fontsize=10,
        fontweight="bold",
